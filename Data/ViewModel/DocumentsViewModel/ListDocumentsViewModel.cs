...
{
    public class ListDocumentsViewModel : BaseViewModel
    {
        ...
        private void DeleteDocument()
        {
            ...
            {
                documentDbRepository.DeleteDokumentInDatabase(SelectedValue.NameDocument);
        ...
        private void Navigate(string ID_Document)
        {
            ...
            Messenger.Default.Send<LocalButtonAndTitle>(new LocalButtonAndTitle() { Visability = "Visible", Title = "Lista dokumentów / Lista towarów na fakturze nr. " + documentDbRepository.GetDocument(Int32.Parse(ID_Document)).NameDocument});
        ...
        public override void OnResume()
        {
            ...
            DocumentColection = new ObservableCollection<Document>(documentDbRepository.GetAllDocumentsInDatabase());
        }
        #endregion
    }
}
