...
{
    public class EditWithListProductsViewModel : BaseViewModel
    {
        ...
        private string SaveMessage = "Zmiany został zapisane";
        ...
        private void SaveChanges()
        {
            ...
            try
            {
                ...
                if (Code != ParentCode)
                {
                    documentProductcsDbRepository.RenameCodeInDocuments(ParentCode, Code);
                }
        ...
        private void NavigateToCategoryView()
        {
            ...
            Messenger.Default.Send<LocalButtonAndTitle>(new LocalButtonAndTitle() { Visability = "Visible", Title = "Lista produktów / Edytuj produkt / Zarządzaj kategoriami (+/-)" });
        }
        #endregion
