    ...
    public class AddProvidersViewModel : BaseViewModel
    {
        ...
        public string Nip
        {
            ...
            set
            {
                ...
                if (!userDbRepository.CheckReproducibility(nip) && (Status != NipReproducibility || Status != NipReproducibility2))
                {
                    Status = string.Empty;
                }
                else if (Status == AddMessage || Status == DraftsMessage)
                {
                    Status = string.Empty;
                }
        ...
        private string AddToDraftsError = "Aby przenieść wprowadzane dane do K.R. należy podać NIP kontrahenta";
        ...
        private string NipReproducibility2 = "Nie można użyć tego numeru NIP. W bazie widnieje już wpis związany z tym numerem";
        ...
        private void AddUserToDrafts()
        {
            ...
            else if (userDbRepository.CheckReproducibility(nip))
            {
                Status = NipReproducibility2;
                ForegroundStatus = "Red";
                return;
            }
            else if (!Strings.IsDigit(Nip))
