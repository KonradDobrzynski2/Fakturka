...
{
    public class EditWithListProvidersViewModel : BaseViewModel
    {
        ...
        public string Nip
        {
            ...
            set
            {
                ...
                else if (Status == SaveChangesMessage)
                {
                    Status = string.Empty;
                }
        ...
        private string SaveChangesMessage = "Zmiany zostały zapisane";
